...
public class DespachoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Despacho> getById(@PathVariable Integer id) {
    ...
    @PostMapping
    public ResponseEntity<Despacho> create(@RequestBody Despacho entity) {
        Despacho saved = service.save(entity);
        return ResponseEntity.status(HttpStatus.CREATED).body(saved);
    }

    @PutMapping("/{id}")
    public ResponseEntity<Despacho> update(@PathVariable Integer id, @RequestBody Despacho entity) {
